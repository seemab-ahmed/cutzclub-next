...
export default function ProfileDetail() {
  ...
  return (
    <>
      ...
      <section class="profile_tabs-data">
        <div className='container'>
         <div class="progile_row">
          <div class="left_col">
            {/* About  */}
            <div class="tab_panel" id="about">
              <div class="about-section">
                ...
                <div class="tag-group">
                  ...
                  <span class="tag">Beard work</span>
                  <span class="tag">Line-ups</span>
                  <span class="tag">Designs</span>
                </div>
              </div>
            </div>
              {/* Reviews  */}
            <div class="tab_panel" id="reviews">
              <div class="reviews-section">
                <h2>Reviews</h2>
                  ...
                  <div class="review-tags">
                    <span class="tag">Apriyl's cut  +</span>
                    <span class="tag">trice rangs</span>
                  </div>
          ...
          <div class="right_col">
            ...
            <div class="tab_panel" id="gallery">
                <div class="gallery-section">
                  ...
                  <p class="location-text">Downtown Norfolk, VA</p>
                  ...
                  <div class="review-box">
                      ...
                      <div class="single-review">
                        <div class="review-top">
                          <span class="reviewer">Marcus G.</span>
                          <span class="review-date">Jan 9, 2025</span>
                        </div>
                        <div class="review-stars">★★★★★</div>
                        <p class="review-text">Sharpcut on time, and super professional. Booking again.</p>
                      </div>

                      <div class="single-review">
                        <div class="review-top">
                          <span class="reviewer">Alina P.</span>
                          <span class="review-date">Dec 22, 2024</span>
                        </div>
                        <div class="review-stars">★★★★☆</div>
                        <p class="review-text">Loved the fade. Clean workspace and easy scheduling.</p>
                      </div>
                    </div>
