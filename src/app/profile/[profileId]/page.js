  ...
  return (
    <>
      ...
      <section className="profile-tabs">
        ...
        <Image src="/assets/images/htw-top1.png" alt="Review 2" width={60} height={60} />
        <Image src="/assets/images/htw-top1.png" alt="Review 3" width={60} height={60} />
        <Image src="/assets/images/htw-top1.png" alt="Review 4" width={60} height={60} />
                  </div>
